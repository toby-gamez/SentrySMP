        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RCONIP = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    RCONPort = table.Column<int>(type: "int", nullable: false),
                    RCONPassword = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
