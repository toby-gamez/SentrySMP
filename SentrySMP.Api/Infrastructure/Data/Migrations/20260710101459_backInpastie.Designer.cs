...
namespace SentrySMP.Api.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260710101459_backInpastie")]
    partial class backInpastie
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SentrySMP.Domain.Entities.Other", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SentrySMP.Domain.Entities.PaymentSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("DisablePayPal")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);

                    b.Property<bool>("DisableStripe")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("SentrySMP.Domain.Entities.TeamMember", b =>
                {
                    ...
                    b.HasIndex("TeamRankId");

                    b.ToTable("TeamMembers");
                });

            modelBuilder.Entity("SentrySMP.Domain.Entities.TeamRank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SentrySMP.Domain.Entities.Voucher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ScopeCategory")
                        .HasMaxLength(30)
            ...
            modelBuilder.Entity("SentrySMP.Domain.Entities.VoucherUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SentrySMP.Domain.Entities.TeamMember", b =>
                {
                    ...
                    b.HasOne("SentrySMP.Domain.Entities.TeamRank", "Rank")
                        .WithMany("Members")
                        .HasForeignKey("TeamRankId")
            ...
            modelBuilder.Entity("SentrySMP.Domain.Entities.VoucherUsage", b =>
                {
                    b.HasOne("SentrySMP.Domain.Entities.Voucher", "Voucher")
                        .WithMany("Usages")
